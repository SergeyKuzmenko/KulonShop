...
<div class="btn-group-fab" role="group" aria-label="Orders Actions">
  <div>
    <button type="button" class="btn btn-main btn-primary has-tooltip" data-placement="left" title="Действия" > <i class="fa fa-bars"></i> </button>
    <button type="button" class="btn btn-sub btn-danger has-tooltip" onclick="actionOrder('delete')" data-placement="left" title="Удалить" > <i class="fa fa-trash-o"></i> </button>
    <button type="button" class="btn btn-sub btn-info has-tooltip" onclick="actionOrder('discard')" data-placement="left" title="По умолчанию" > <i class="fa fa-file-o"></i> </button>
    <button type="button" class="btn btn-sub btn-warning has-tooltip" onclick="actionOrder('canceled')" data-placement="left" title="Отказ"> <i class="fa fa-times"></i> </button>
    <button type="button" class="btn btn-sub btn-success has-tooltip" onclick="actionOrder('successed')" data-placement="left" title="Подтверждение"> <i class="fa fa-check"></i> </button>
  </div>
</div>
@endsection
